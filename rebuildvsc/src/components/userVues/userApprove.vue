                    ...
                    <el-container width="80%">
                        <el-main>
                            ...
                            <el-table border size="mini" :row-style="{ height: '0' }" :data="pageData" width='100%'>
                                <el-table-column prop="name" label="姓名" align="center" min-width='30%'>
                                </el-table-column>
                                <el-table-column prop="workshop__name" label="部门" align="center" min-width='20%'>
                                </el-table-column>
                                <el-table-column prop="email" label="邮箱" align="center" min-width='30%'>
                                </el-table-column>
                            ...
                            <el-dialog :title="dialogTitle" :visible.sync="dialogFormVisible" width="30%"
                                ...
                                <el-form :model="singleMaterial" :rules="rules" ref="dialogForm">
                                    <el-form-item label="姓名" :label-width="formLabelWidth" prop="name">
                                        <el-input disabled="true" v-model="singleMaterial.name"
                                            autocomplete="off"></el-input>
                                    </el-form-item>
                                    <el-form-item label="部门" :label-width="formLabelWidth" prop="workshop__id">
                                        <el-input disabled="true" v-model="singleMaterial.workshop__name"
                                            autocomplete="off"></el-input>
                                    </el-form-item>
                                    <el-form-item label="邮箱" :label-width="formLabelWidth" prop="email">
                                        <el-input disabled="true" v-model="singleMaterial.email"
                                            autocomplete="off"></el-input>
                                    </el-form-item>
...
export default {
    ...
    methods: {
        ...
        getAllUserInfo() {
            let that = this
            this.$api.userAPI.getNeedApproveUser()
                .then(function (res) {
                    if (res.data.code == 1) {
