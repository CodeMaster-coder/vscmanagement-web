                    ...
                    <el-container width="80%">
                        <el-main>
                            ...
                            <el-table border size="mini" :row-style="{ height: '40px' }" :data="pageData" width='100%'>
                                <el-table-column prop="maintain_record__apply_record__equipment__name" label="工具名称" align="center"
                                    min-width='23%'>
                                </el-table-column>
                                <el-table-column prop="maintain_record__apply_record__equipment__type" label="工具型号" align="center"
                                    min-width='22%'>
                                </el-table-column>
                                <el-table-column prop="maintain_record__apply_record__equipment__unit" label="单位" align="center"
                                    min-width='9%'>
                                </el-table-column>
                                <el-table-column prop="maintain_record__apply_record__aplly_quantity" label="申请数量" align="center"
                                    min-width='9%'>
                                </el-table-column>                                
                                <el-table-column prop="maintain_record__apply_record__apply_name__name" label="申请人" align="center"
                                    min-width='9%'>
                                </el-table-column>
                                <el-table-column prop="maintain_record__apply_record__apply_date" label="申请时间" align="center"
                                    min-width='9%'>
                                </el-table-column>
                                <el-table-column prop="maintain_record__maintain_name__name" label="维修人" align="center" min-width='9%'>
                                </el-table-column>
                                <el-table-column prop="maintain_record__repaired_date" label="修复日期" align="center" min-width='9%'>
                                </el-table-column>
                                <el-table-column prop="confirm_name__name" label="确认人" align="center" min-width='9%'>
                                </el-table-column>
                                <el-table-column prop="confirm_date" label="确认日期" align="center" min-width='9%'>
                                </el-table-column>
                            ...
                            <el-dialog :title="dialogTitle" :visible.sync="dialogFormVisible" width="50%"
                                ...
                                <el-form :model="singleTool" :rules="rules" ref="dialogForm" :inline="true">
                                    <el-form-item label="工具名称：" :label-width="formLabelWidth">
                                        <el-input :disabled="true" v-model="singleTool.maintain_record__apply_record__equipment__name"
                                            autocomplete="off"></el-input>
                                    </el-form-item>
                                    <el-form-item label="工具型号：" :label-width="formLabelWidth">
                                        <el-input :disabled="true" v-model="singleTool.maintain_record__apply_record__equipment__type"
                                            autocomplete="off"></el-input>
                                    </el-form-item>
                                    <el-form-item label="单位：" :label-width="formLabelWidth">
                                        <el-input :disabled="true" v-model="singleTool.maintain_record__apply_record__equipment__unit"
                                            autocomplete="off"></el-input>
                                    </el-form-item>
                                    <el-form-item label="申请时间：" :label-width="formLabelWidth">
                                        <el-input :disabled="true" v-model.number="singleTool.maintain_record__apply_record__apply_date"
                                            autocomplete="off"></el-input>
                                    </el-form-item>
                                    <el-form-item label="申请人：" :label-width="formLabelWidth">
                                        <el-input v-model.number="singleTool.maintain_record__apply_record__apply_name__name"
                                            :disabled="true" autocomplete="off"></el-input>
                                    </el-form-item>
                                    <el-form-item label="申请维修数量：" :label-width="formLabelWidth">
                                        <el-input :disabled="true"
                                            v-model.number="singleTool.maintain_record__apply_record__aplly_quantity"
                                            autocomplete="off"></el-input>
                                    </el-form-item>
                                    <el-form-item label="区域：" :label-width="formLabelWidth">
                                        <el-input :disabled="true" v-model.number="singleTool.maintain_record__apply_record__area__name"
                                            autocomplete="off"></el-input>
                                    </el-form-item>
                                    <el-form-item label="维修人员：" :label-width="formLabelWidth">
                                        <el-input :disabled="true" v-model="singleTool.maintain_record__maintain_name__name"
                                            autocomplete="off"></el-input>
                                    </el-form-item>
                                    <el-form-item label="故障详情：" :label-width="formLabelWidth">
                                        <el-input :disabled="true" type="textarea"
                                            v-model="singleTool.maintain_record__apply_record__problem_detail" :rows="8"
                                            autocomplete="off"></el-input>
                                    </el-form-item>
                                    ...
                                    <el-form-item label="维修措施：" :label-width="formLabelWidth" prop="solution">
                                        <el-input :disabled="true" v-model="singleTool.maintain_record__solution" autocomplete="off"
                                    ...
                                    <el-form-item label="更换备件：" :label-width="formLabelWidth">
                                        <template>
                                            <el-radio :disabled="true" v-model="singleTool.maintain_record__part_change"
                                                :label="true">是</el-radio>
                                            <el-radio :disabled="!isEdit" v-model="singleTool.maintain_record__part_change"
                                    ...
                                    <el-form-item label="截止日期：" :label-width="formLabelWidth" prop="deadline">
                                        <div class="block">
                                            <el-date-picker value-format="yyyy-MM-dd" format="yyyy-MM-dd"
                                                :disabled="true" v-model="singleTool.maintain_record__deadline" type="date"
                                                placeholder="选择截止日期">
                                            </el-date-picker>
                                        </div>
                                    </el-form-item>
                                    ...
                                    <el-form-item label="是否修复：" :label-width="formLabelWidth">
                                        <template>
                                            <el-radio :disabled="true" v-model="singleTool.maintain_record__repaired_or_not"
                                                :label="true">是</el-radio>
                                            <el-radio :disabled="!isEdit" v-model="singleTool.maintain_record__repaired_or_not"
                                                :label="false">否</el-radio>
                                        </template>
                                    </el-form-item>
                                    <el-form-item label="修复日期：" :label-width="formLabelWidth" prop="repaired_date">
                                        <div class="block">
                                            <el-date-picker value-format="yyyy-MM-dd" format="yyyy-MM-dd"
                                                :disabled="true"
                                                v-model="singleTool.maintain_record__repaired_date" type="date" placeholder="选择修复日期">
                                            </el-date-picker>
                                        </div>
                                    </el-form-item>
                                </el-form>
                                <div slot="footer" class="dialog-footer">
                                    <el-button  type="primary" size="mini" @click="deleteBtn()">
                                        删除
                                    </el-button>
                                    <el-button  type="primary" size="mini" @click="cancelDialog()">
                                        取消
                                    </el-button>
                                </div>
                            </el-dialog>
...
export default {
    ...
    methods: {
        exportToExcel(){
            let that=this
            that.$exportToExcel(that.tableData,'设备维修记录.xlsx')
        },
        //修改每页的分页行数
        ...
        getAllToolStorage(workshop) {
            ...
            this.$api.equipmentAPI.getAllConfirmMaintain({ workshop: workshop })
                .then(function (res) {
                    if (res.data.code == 1) {
                        that.$message.success('获取维修记录成功！')
        ...
        detailBtn(row) {
            ...
            this.dialogTitle = "维修过程详情"
            this.singleTool = JSON.parse(JSON.stringify(row));
            this.imageUrl = this.baseUrl + 'media/' + this.singleTool.maintain_record__apply_record__apply_imgs[0]
            this.srcList = this.singleTool.maintain_record__apply_record__apply_imgs.map(
                img => { return this.baseUrl + 'media/' + img }
            )
            this.maintainImageUrl = that.getImageSrc(that.singleTool.maintain_record__maintain_imgs)
            this.maintainSrcList = that.getPreviewSrcList(that.singleTool.maintain_record__maintain_imgs)
        },
        //拼接得到图片路径
        getImageSrc(imgs) {
        ...
        deleteBtn() {
            ...
            that.$checkUserAuth(JSON.parse(sessionStorage.getItem('userInfo')).key.id, 6).then(
                res => {
                    if (res) {
            that.$api.equipmentAPI.deleteConfirmMaintain({ maintainRecord: that.singleTool })
                .then(function (res) {
                    // console.log(res)
                    if (res.data.code == 1) {
                        that.$message.success('维修记录删除成功！')
                        that.cancelDialog()
