                        ...
                        <el-main>
                                    ...
                                    <el-col :span="6" size="mini">
                                        <el-button-group size="mini">
                                            ...
                                            <el-button type="primary" size="mini"
                                                @click="addNewTool()">导出Excel</el-button>
                                        </el-button-group>
                                    </el-col>
                                </el-row>
                            </el-form>
                            <el-table border size="mini" :row-style="{ height: '0' }" :data="pageData" width='100%'>
                                <el-table-column prop="TPM_apply_record__approve_record__apply_record__tool__name"
                                    label="工具名称" align="center" min-width='17.5%'>
                                </el-table-column>
                                <el-table-column prop="TPM_apply_record__approve_record__apply_record__tool__type"
                                    label="工具型号" align="center" min-width='17.5%'>
                                </el-table-column>
                                <el-table-column prop="TPM_apply_record__approve_record__apply_record__tool__unit"
                                    label="单位" align="center" min-width='5%'>
                                </el-table-column>
                                <el-table-column prop="TPM_apply_record__apply_quantity" label="申请数量" align="center"
                                    min-width='9%'>
                                </el-table-column>
                                <el-table-column prop="TPM_apply_record__apply_date" label="申请时间" align="center"
                                    min-width='9%'>
                                </el-table-column>
                                <el-table-column prop="TPM_apply_record__apply_comments" label="申请备注" align="center"
                                    min-width='20%'>
                                </el-table-column>
                                <el-table-column prop="TPM_approve_date" label="TPM批准时间" align="center" min-width='9%'>
                                </el-table-column>
                                <el-table-column prop="TPM_approve_comments" label="TPM批准备注" align="center"
                                    min-width='20%'>
                                </el-table-column>
                            ...
                            <el-dialog :title="dialogTitle" :visible.sync="dialogFormVisible" width="50%"
                                ...
                                <el-form :model="singleTool" :rules="rules" ref="dialogForm" :inline="true">
                                    <el-form-item label="工具名称：" :label-width="formLabelWidth">
                                        <el-input :disabled="true"
                                            v-model="singleTool.TPM_apply_record__approve_record__apply_record__tool__name"
                                            autocomplete="off"></el-input>
                                    </el-form-item>
                                    <el-form-item label="工具型号：" :label-width="formLabelWidth">
                                        <el-input :disabled="true"
                                            v-model="singleTool.TPM_apply_record__approve_record__apply_record__tool__type"
                                            autocomplete="off"></el-input>
                                    </el-form-item>
                                    <el-form-item label="单位：" :label-width="formLabelWidth">
                                        <el-input :disabled="true"
                                            v-model="singleTool.TPM_apply_record__approve_record__apply_record__tool__unit"
                                            autocomplete="off"></el-input>
                                    </el-form-item>
                                    <el-form-item label="出库时间：" :label-width="formLabelWidth">
                                        <el-input :disabled="true"
                                            v-model.number="singleTool.TPM_apply_record__approve_record__approve_date"
                                            autocomplete="off"></el-input>
                                    </el-form-item>
                                    <el-form-item label="批准出库人：" :label-width="formLabelWidth">
                                        <el-input
                                            v-model.number="singleTool.TPM_apply_record__approve_record__approve_username__name"
                                            :disabled="true" autocomplete="off"></el-input>
                                    </el-form-item>
                                    <el-form-item label="申请报废数量：" :label-width="formLabelWidth">
                                        <el-input :disabled="true"
                                            v-model.number="singleTool.TPM_apply_record__apply_quantity"
                                            autocomplete="off"></el-input>
                                    </el-form-item>
                                    <el-form-item label="申请报废时间：" :label-width="formLabelWidth">
                                        <el-input :disabled="true"
                                            v-model.number="singleTool.TPM_apply_record__apply_date"
                                            autocomplete="off"></el-input>
                                    </el-form-item>
                                    <el-form-item label="申请报废人：" :label-width="formLabelWidth">
                                        <el-input
                                            v-model.number="singleTool.TPM_apply_record__approve_record__apply_record__apply_userName__name"
                                            :disabled="true" autocomplete="off"></el-input>
                                    </el-form-item>
                                    <el-form-item label="申请报废备注：" :label-width="formLabelWidth">
                                        <el-input :disabled="true" type="textarea"
                                            v-model="singleTool.TPM_apply_record__apply_comments" :rows="8"
                                            autocomplete="off"></el-input>
                                    </el-form-item>
                                    ...
                                    <el-form-item label="TPM批准备注：" :label-width="formLabelWidth">
                                        <el-input :disabled="true" type="textarea"
                                            v-model="singleTool.TPM_approve_comments" :rows="8"
                                            autocomplete="off"></el-input>
                                    </el-form-item>
                                ...
                                <div slot="footer" class="dialog-footer">
                                    ...
                                    <el-button type="primary" icon="el-icon-check" size="mini" @click="approveBtn()">
                                        批准
                                    </el-button>
                                </div>
                            </el-dialog>
...
export default {
    ...
    methods: {
        ...
        getAllToolStorage(userId) {
            ...
            this.$api.toolAPI.scrapTPMapply({ workshopId: JSON.parse(sessionStorage.getItem('userInfo')).key.workshop })
                .then(function (res) {
                    if (res.data.code == 1) {
                        that.$message.success('获取待报废工具成功！')
        ...
        detailBtn(row) {
            ...
            this.dialogTitle = "报废申请详情"
            this.singleTool = JSON.parse(JSON.stringify(row));
            this.imageUrl = this.baseUrl + 'media/' + this.singleTool.TPM_apply_record__apply_img
        ...
        approveBtn() {
            ...
            let that = this
            this.$checkUserAuth(JSON.parse(sessionStorage.getItem('userInfo')).key.id, 7).then(
                res => {
                    if (res) {
        ...
        deleteBtn() {
            ...
            this.$checkUserAuth(JSON.parse(sessionStorage.getItem('userInfo')).key.id, 7).then(
                res => {
                    if (res) {
            that.$api.toolAPI.deleteTPMapprove({ singleTool: that.singleTool })
                .then(function (res) {
                    // console.log(res)
                    if (res.data.code == 1) {
                        that.$message.success('TPM申请删除成功！')
                        that.cancelDialog()
                        that.getAllToolStorage(that.userId)
                    } else {
                        that.$message.error(res.data.msg)
