                    ...
                    <el-container width="80%">
                        <el-main>
                            ...
                            <el-table border size="mini" :row-style="{ height: '0' }" :data="pageData" width='100%'>
                                <el-table-column prop="approve_record__apply_record__tool__name" label="工具名称"
                                    align="center" min-width='25%'>
                                </el-table-column>
                                <el-table-column prop="approve_record__apply_record__tool__type" label="工具型号"
                                    align="center" min-width='25%'>
                                </el-table-column>
                                <el-table-column prop="approve_record__apply_record__tool__unit" label="单位"
                                    align="center" min-width='9%'>
                                </el-table-column>
                                <el-table-column prop="apply_quantity" label="申请数量" align="center" min-width='9%'>
                                </el-table-column>
                                <el-table-column prop="apply_date" label="申请时间" align="center" min-width='9%'>
                                </el-table-column>
                                <el-table-column prop="apply_comments" label="申请备注" align="center" min-width='25%'>
                                </el-table-column>
                                ...
                                <el-form :model="singleTool" :rules="rules" ref="dialogForm" :inline="true">
                                    <el-form-item label="工具名称：" :label-width="formLabelWidth">
                                        <el-input :disabled="true"
                                            v-model="singleTool.approve_record__apply_record__tool__name"
                                            autocomplete="off"></el-input>
                                    </el-form-item>
                                    <el-form-item label="工具型号：" :label-width="formLabelWidth">
                                        <el-input :disabled="true"
                                            v-model="singleTool.approve_record__apply_record__tool__type"
                                            autocomplete="off"></el-input>
                                    </el-form-item>
                                    <el-form-item label="单位：" :label-width="formLabelWidth">
                                        <el-input :disabled="true"
                                            v-model="singleTool.approve_record__apply_record__tool__unit"
                                            autocomplete="off"></el-input>
                                    </el-form-item>
                                    <el-form-item label="出库时间：" :label-width="formLabelWidth">
                                        <el-input :disabled="true"
                                            v-model.number="singleTool.approve_record__approve_date"
                                            autocomplete="off"></el-input>
                                    </el-form-item>
                                    <el-form-item label="批准出库人：" :label-width="formLabelWidth">
                                        <el-input v-model.number="singleTool.approve_record__approve_username__name"
                                            :disabled="true" autocomplete="off"></el-input>
                                    </el-form-item>
                                    <el-form-item label="申请报废数量：" :label-width="formLabelWidth">
                                        <el-input :disabled="true" v-model.number="singleTool.apply_quantity"
                                            autocomplete="off"></el-input>
                                    </el-form-item>
                                    ...
                                    <el-form-item label="申请报废人：" :label-width="formLabelWidth">
                                        <el-input
                                            v-model.number="singleTool.approve_record__apply_record__apply_userName__name"
                                            :disabled="true" autocomplete="off"></el-input>
                                    </el-form-item>
                                    <el-form-item label="申请报废备注：" :label-width="formLabelWidth">
                                        <el-input :disabled="true" type="textarea" v-model="singleTool.apply_comments"
                                    ...
                                    <el-form-item label="TPM批准备注：" :label-width="formLabelWidth"
                                        prop="TPMapproveComments">
                                        <el-input type="textarea" v-model="singleTool.TPMapproveComments" :rows="8"
                                            autocomplete="off"></el-input>
                                    </el-form-item>
...
export default {
    ...
    methods: {
        ...
        getAllToolStorage(userId) {
            ...
            this.$api.toolAPI.getScrapApply({ workshopId: JSON.parse(sessionStorage.getItem('userInfo')).key.workshop })
                .then(function (res) {
                    if (res.data.code == 1) {
        ...
        detailBtn(row) {
            ...
            this.imageUrl = this.baseUrl + 'media/' + this.singleTool.apply_img
                ...
                res => {
                    if (res) {
                        that.$refs.dialogForm.validate(async (valid) => {
                            if (valid) {
                                that.$api.toolAPI.scrapTPMapprove({ singleTool: that.singleTool, userId: that.userId, workshop: JSON.parse(sessionStorage.getItem('userInfo')).key.workshop })
                                    .then(function (res) {
                                        console.log(res)
                                        if (res.data.code == 1) {
