                    ...
                    <el-container width="80%">
                        <el-main>
                            ...
                            <el-table border size="mini" :row-style="{ height: '0' }" :data="pageData" width='100%'>
                                <el-table-column prop="apply_record__tool__name" label="工具名称" align="center"
                                    min-width='25%'>
                                </el-table-column>
                                <el-table-column prop="apply_record__tool__type" label="工具型号" align="center"
                                    min-width='25%'>
                                </el-table-column>
                                <el-table-column prop="apply_record__tool__unit" label="单位" align="center"
                                    min-width='9%'>
                                </el-table-column>
                                <el-table-column prop="apply_record__apply_quantity" label="领用数量" align="center"
                                    min-width='9%'>
                                </el-table-column>
                                <el-table-column prop="apply_record__apply_date" label="申请时间" align="center"
                                    min-width='9%'>
                                </el-table-column>
                                <el-table-column prop="approve_date" label="批准时间" align="center" min-width='9%'>
                                </el-table-column>
                                <el-table-column prop="approve_username__name" label="批准人" align="center"
                                    min-width='9%'>
                                </el-table-column>
                                <el-table-column label="操作" size="mini" align="center" min-width='16%'>
                                    <template slot-scope="scope">
                                        <el-button type="primary" icon="el-icon-s-release" size="mini"
                                            @click="scrapBtn(scope.row)">
                                            报废
                                        </el-button>
                            ...
                            <el-dialog :title="dialogTitle" :visible.sync="dialogFormVisible" width="50%"
                                ...
                                <el-form :model="singleTool" :rules="rules" ref="dialogForm" :inline="true">
                                    <el-form-item label="工具名称：" :label-width="formLabelWidth"
                                        prop="apply_record__tool__name">
                                        <el-input :disabled="true" v-model="singleTool.apply_record__tool__name"
                                            autocomplete="off"></el-input>
                                    </el-form-item>
                                    <el-form-item label="工具型号：" :label-width="formLabelWidth"
                                        prop="apply_record__tool__type">
                                        <el-input :disabled="true" v-model="singleTool.apply_record__tool__type"
                                            autocomplete="off"></el-input>
                                    </el-form-item>
                                    <el-form-item label="单位：" :label-width="formLabelWidth"
                                        prop="apply_record__tool__unit">
                                        <el-input :disabled="true" v-model="singleTool.apply_record__tool__unit"
                                            autocomplete="off"></el-input>
                                    </el-form-item>
                                    <el-form-item label="领用数量：" :label-width="formLabelWidth"
                                        prop="apply_record__apply_quantity">
                                        <el-input :disabled="true"
                                            v-model.number="singleTool.apply_record__apply_quantity"
                                            autocomplete="off"></el-input>
                                    </el-form-item>
                                    <el-form-item label="申请时间：" :label-width="formLabelWidth"
                                        prop="apply_record__apply_date">
                                        <el-input :disabled="true" v-model.number="singleTool.apply_record__apply_date"
                                            autocomplete="off"></el-input>
                                    </el-form-item>
                                    <el-form-item label="批准时间：" :label-width="formLabelWidth" prop="approve_date">
                                        <el-input v-model.number="singleTool.approve_date" :disabled="true"
                                            autocomplete="off"></el-input>
                                    </el-form-item>
                                    <el-form-item label="批准人：" :label-width="formLabelWidth" prop="approve_date">
                                        <el-input v-model.number="singleTool.approve_username__name" :disabled="true"
                                            autocomplete="off"></el-input>
                                    </el-form-item>
                                    <el-form-item :label="quantityLabel" :label-width="formLabelWidth"
                                        prop="apply_scrap_quantity">
                                        <el-input v-model.number="singleTool.apply_scrap_quantity"
                                            autocomplete="off"></el-input>
                                    </el-form-item>
                                    <el-form-item label="申请备注：" :label-width="formLabelWidth" v-if="isEdit"
                                        prop="apply_scrap_comments">
                                        <el-input type="textarea" v-model="singleTool.apply_scrap_comments" :rows="8"
                                            autocomplete="off"></el-input>
                                    </el-form-item>
                                    <el-form-item label="报废图片：" :label-width="formLabelWidth" v-if="isEdit"
                                        prop="imageUrl">
                                        <el-upload class="avatar-uploader" :http-request="imgUploadPost"
                                            action="https://jsonplaceholder.typicode.com/posts/" :show-file-list="false"
                                            :on-success="handleAvatarSuccess">
                                            <img v-if="singleTool.imageUrl" :src="singleTool.imageUrl" class="avatar">
...
export default {
    data() {
        return {
            ...
            imageUrl: "",
            singleTool: {
                apply_record__tool__name: null,
                apply_record__tool__type: null,
                apply_record__tool__unit: null,
                apply_record__apply_quantity: null,
                apply_record__apply_date: null,
                approve_date: null,
                approve_username__name: null,
                apply_scrap_quantity: null,
                apply_scrap_comments: null,
                image: null,
                imageUrl: null
            },
            rules: {
                apply_record__tool__name: [
                    { required: true, message: '工具名称不能为空！', trigger: 'blur' }
                ],
                apply_record__tool__type: [
                    { required: true, message: '工具型号不能为空！', trigger: 'blur' }
                ],
                apply_record__tool__unit: [
                    { required: true, message: '工具单位不能为空！', trigger: 'blur' }
                ],
                apply_record__apply_quantity: [
                    { required: true, message: '工具库存数量不能为空！', trigger: 'blur' },
                ],
                apply_record__apply_date: [
                    { required: true, message: '工具安全量不能为空！', trigger: 'blur' },
                ],
                approve_date: [
                    { required: true, message: '领用数量不能为空！', trigger: 'blur' },
                ],
                approve_username__name: [
                    { required: true, message: '工具安全量不能为空！', trigger: 'blur' },
                ],
                apply_scrap_quantity: [
                    { required: true, message: '申请数量不能为空！', trigger: 'blur' },
                    { type: 'number', message: '申请数量必须为整数' },
                    {
                        validator: (rules, value, callback) => {
                            if (value > this.singleTool.apply_record__apply_quantity) {
                                callback(new Error('申请数量不能大于个人名下数量！'));
                            } else {
                                callback();
                            }
                        },
                ...
                apply_scrap_comments: [
                    { required: true, message: '申请报废备注不能为空！', trigger: 'blur' },
                ],
                imageUrl: [
                    {
                        validator: (rules, value, callback) => {
                            if (value == null) {
                                callback(new Error('报废图片不能为空！'));
                            } else {
                                callback();
                            }
                        },
    ...
    methods: {
        ...
        getAllToolStorage(userId) {
            ...
            this.$api.toolAPI.getPersonalTool({ applyUserId: userId })
                .then(function (res) {
                    if (res.data.code == 1) {
            ...
            that.$refs.dialogForm.validate(async (valid) => {
                if (valid) {
                    if (that.isEdit) {
                        ...
                        this.$api.toolAPI.scrapApply({ outboundApproveId: that.applyRow.id, singleTool: that.singleTool, nousedImgList: filteredTempSrapImg, outboundApplyId: that.applyRow.apply_record__id, workshop:JSON.parse(sessionStorage.getItem('userInfo')).key.workshop })
                            .then(function (res) {
                                console.log(res)
                                if (res.data.code == 1) {
